...
try
{
	...
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/unicrypto","root","ghost227#"); //create connection
	...
	if(request.getParameter("btn_register")!=null) //check register button click event not null
	{
		...
		response.sendRedirect("signup.jsp"); //register success messeage
...
<head>
	...
	<title>Register : Unicrypto</title>
    ...
    <div class="main-content">
        ...
        <form class="form-register" method="post" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
                ...
                <a href="/Bitcoin_war_exploded/signup.jsp" class="form-log-in-with-existing">Already have an account? <b> Login here </b></a>
